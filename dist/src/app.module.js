...
const device_service_1 = require("./modules/devices/device.service");
...
AppModule = __decorate([
    common_1.Module({
        ...
        controllers: [device_controller_1.DevicesController],
        providers: [device_service_1.DevicesService],
    })
], AppModule);
